...
class Args:
    ...
    pretrained_path: str = "/mnt/petrelfs/wangfangjing/code/starVLA/results/Checkpoints/1029_qwenGR00T_fourier_gr1_unified_1000_PnPMilkToMicrowaveClose_gpus_woPretrain_wState/checkpoints/steps_20000_pytorch_model.pt"
